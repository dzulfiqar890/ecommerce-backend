...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="#"><i class='bx bxs-widget icon' ></i> Detail Pesanan</a></li>
	...
	<section id="content">
		...
		<main>
			...
			<ul class="breadcrumbs">
				...
				<li class="divider">/</li>
				<li><a href="#" class="active">Detail Pesanan</a></li>
			</ul>
    ...
    <table class="product-table">
        ...
        <tbody>
            <tr>
				<td>Andi Wijaya</td>
                <td>Headphone Wireless Premium</td>
                <td>Rp 1,299,000</td>
                <td>Rp 2,598,000</td>
                <td>2</td>
            </tr>
            <tr>
				<td>Rina Sari</td>
                <td>Smartphone Android Flagship</td>
                <td>Rp 8,999,000</td>
                <td>Rp 8,999,000</td>
                <td>1</td>
            </tr>
